            ...
            foreach($datos as $rows){
                $tabla.='
                    <tr class="has-text-centered" >
                        ...
                        <td>
                            <a href="'.$url.$pagina.'&category_id_del='.$rows["id_$tablas[$pos]"].'&category_table='.$tablas[$pos].'" class="button is-danger is-rounded is-small">Eliminar</a>
                        </td>
                    </tr>
                ';
                $contador++;
        ...
        foreach($datos_genre as $rows){
            ...
            $tabla.='
                <tr class="has-text-centered" >
                    ...
                    <td>
                        <a href="'.$url.$pagina.'&category_id_del='.$rows['id_genero'].'&category_table=genero" class="button is-danger is-rounded is-small">Eliminar</a>
                    </td>
                </tr>
            ';
            ...
            foreach($datos_plat as $rows){
                ...
                $tabla.='
                    <tr class="has-text-centered" >
                        ...
                        <td>
                            <a href="'.$url.$pagina.'&category_id_del='.$rows['id_plataforma'].'&category_table=plataforma" class="button is-danger is-rounded is-small">Eliminar</a>
                        </td>
                    </tr>
                ';
        ...
        foreach($datos_franq as $rows){
            ...
            $tabla.='
                <tr class="has-text-centered" >
                    ...
                    <td>
                        <a href="'.$url.$pagina.'&category_id_del='.$rows['id_franquicia'].'&category_table=franquicia" class="button is-danger is-rounded is-small">Eliminar</a>
                    </td>
                </tr>
            ';
        }
        ...
        foreach($datos_clas as $rows){
            ...
            $tabla.='
                <tr class="has-text-centered" >
                    ...
                    <td>
                        <a href="'.$url.$pagina.'&category_id_del='.$rows['id_clasificacion'].'&category_table=clasificacion" class="button is-danger is-rounded is-small">Eliminar</a>
                    </td>
                </tr>
            ';
        }
